...
class TestGroupSettings:
    ...
    @pytest.fixture
    def event_env(self, session_factory, mock_llm, test_config, mock_queue_processor):
    ...
    async def test_queue_processor_skips_messages_when_bot_disabled(
        self, session_factory, test_session, mock_llm, test_config
    ):
        ...
        queue_processor = QueueProcessor(
            session_factory, mock_llm, mock_client, test_config
        )
