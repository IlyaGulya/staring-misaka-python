...
class TestTelegramIntegration:
    ...
    @pytest.fixture
    def queue_processor_with_integration(self, session_factory, mock_llm, mock_telegram_client, test_config):
    ...
    @pytest.mark.asyncio
    async def test_message_handler_adds_to_queue(self, session_factory, test_session, mock_llm, mock_telegram_event, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_message_handler_ignores_approved_user(self, session_factory, test_session, mock_llm, mock_telegram_event, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_message_handler_ignores_existing_user(self, session_factory, test_session, mock_llm, mock_telegram_event, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_message_handler_fallback_when_no_queue_processor(self, session_factory, test_session, mock_llm, mock_telegram_event, test_config):
    ...
    @pytest.mark.asyncio
    async def test_message_handler_fallback_error_handling(self, session_factory, test_session, mock_llm, mock_telegram_event, test_config):
    ...
    @pytest.mark.asyncio
    async def test_admin_queue_status_command(self, session_factory, test_session, mock_llm, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_admin_retry_failed_command(self, session_factory, test_session, mock_llm, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_admin_clear_completed_command(self, session_factory, test_session, mock_llm, queue_processor_with_integration, test_config):
    ...
    @pytest.mark.asyncio
    async def test_non_admin_queue_command_rejection(self, session_factory, test_session, mock_llm, queue_processor_with_integration, test_config):
