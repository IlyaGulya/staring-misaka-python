...
class TestQueueProcessor:
    ...
    @pytest.mark.asyncio
    async def test_add_message_to_queue(self, queue_processor):
        ...
        queue_item = await queue_processor.add_message_to_queue(user_id, chat_id, message_id, message_text)
    ...
    @pytest.mark.asyncio
    async def test_add_duplicate_message_to_queue(self, queue_processor):
        ...
        # Add first message
        first_item = await queue_processor.add_message_to_queue(user_id, chat_id, message_id, message_text)

        # Add same message again
        second_item = await queue_processor.add_message_to_queue(user_id, chat_id, message_id, message_text)
