...
class TestAdminCommands:
    @pytest.fixture
    def queue_processor_with_messages(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
    ...
    def test_get_queue_status_empty_queue(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
    ...
    def test_retry_failed_messages_none_eligible(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
    ...
    def test_clear_completed_messages_no_completed(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
    ...
    def test_admin_commands_integration_with_telegram_bot(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
    ...
    def test_admin_settings_integration(self, test_session, mock_llm, mock_userbot, mock_telegram_client, test_config):
