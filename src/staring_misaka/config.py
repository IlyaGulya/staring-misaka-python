...
class Settings(BaseModel):
    ...
    gradio_username: str | None = Field(None, validation_alias="GRADIO_USERNAME")
    gradio_password: SecretStr | None = Field(None, validation_alias="GRADIO_PASSWORD")
    gradio_port: int = Field(7860, validation_alias="GRADIO_PORT")
